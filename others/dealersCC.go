...
type CarModel struct {
	...
	Parts []CarPart `gorm:"many2many:car_model_parts;"`
...
type CarPart struct {
	...
	CarModels  []CarModel `gorm:"many2many:car_model_parts;" json:"car_models"` // Explicit relation
	ShopParts  []ShopPart `gorm:"foreignKey:CarPartID"`
}
